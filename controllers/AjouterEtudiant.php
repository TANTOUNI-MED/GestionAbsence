...
<form action="../controllers/Ajouter.php" method="post" class="Form-ModifAbs" style="width:70%;margin-left:15%;">
    ...
    <div style="display:flex;width:100%;">
        <div style="width:50%;">
            <input type="text" name="Phone" placeholder="Phone Portable ..." required class="input">
        </div>
        <div style="width:50%;">
            <input type="email" name="Email" placeholder="Email Academique..." required class="input">
        </div>
    </div>
    <div style="display:flex;width:100%;">
    ...
    <input style="width:95%;" type="submit" name="submitAjoutEtud" value="Ajouter">
</form>